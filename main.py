...
# documento_pdf.drawString(100, 700 - 1 * f"Departamento- {departamento}")
# documento_pdf.drawString(100, 700 - 2 * f"Quantidade de horas extras - {horas_extras}")
# documento_pdf.drawString(100, 700 - 3 * f"Mês de refêrencia - {mes_ref}")
# documento_pdf.drawString(100, 700 - 1 *f"Esse relatório foi gerado automaticamente em Python")
